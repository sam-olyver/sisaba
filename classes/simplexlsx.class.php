...
class SimpleXLSX {
	...
	public $built_in_cell_formats = array(
		0 => 'General',
		1 => '0',
		2 => '0.00',
		3 => '#,##0',
	...
	// parametro seleciona a aba desejada da planilha | sheets numeration: 1,2,3....
	//segundo paremetro seleciona linha e coluna do array para retorno, util em estruturas de repeticao
	public function rows( $worksheet_id = 1, $linha = null, $coluna = null ) {
		...
		//if adicionado para retorno
		if($linha == null && $coluna == null)
			return $rows;
		else
			return $rows[$linha][$coluna];
	}
	//semelhante a funcao row(), este cria um array com o detalhes dos tipos primitivos de dados e posicoes da planilha excel e seus valores... 
...
//						'name' => chr($i + 65).($curR+1),
	...
	// thx Gonzo
	public function _columnIndex( $cell = 'A1' ) {
