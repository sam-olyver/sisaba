...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="" method="POST">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Rf" name="userdata[user_rf]" required />
        <span class="glyphicon glyphicon-credit-card form-control-feedback"></span>
      </div>
	  <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Cargo" name="userdata[user_cargo]" required />
